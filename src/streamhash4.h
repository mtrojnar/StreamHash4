...
int STREAMHASH4_Init(STREAMHASH4_CTX *state);
int STREAMHASH4_Update(STREAMHASH4_CTX *state, const void *data, size_t len);
int STREAMHASH4_Final(STREAMHASH4_CTX *state, void *md);
int STREAMHASH4(const void *data, size_t len, void *md);

/* end of streamhash4.h */
